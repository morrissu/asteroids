...
public class Constants
{
     ...
     * Duration in milliseconds of a bullet before it disappears.
     */
    public final static int DEBRIS_DURATION = 1200; //-M
     ...
     * Debris speed
     */
    public final static int DEBRIS_SPEED = 4; //-M
    
    

    //---------------------God Mode variable area-----------------------------------//
    // VinC added, used to indicate if the enhancedMode on, Asteroids class is the only place can change enhancedMode
    public static boolean enhancedMode = false; 
    
	 // VinC added, used for multiFire, not final, changeable
	public static boolean isMultiFire = false; //-VinC
	
	// VinC added, used for undead ship
	public static boolean isUndeadShip = false; //-VinC
	
	// VinC added, used for define the rate of getting loot from asteroids
	public final static float LOOTRATE = 0.5f;
	
    //--------------------------------------------------------//
	
	//-------------constant that corresponding to sound type-------------------------//
	public final static int FIRE = 1;
	public final static int BANGSMALL = 2;
	public final static int BANGMEDIUM = 3;
	public final static int BANGLARGE = 4;
	public final static int THRUST = 5;
	public final static int BEAT1 = 6;
	public final static int BEAT2 = 7;
	public final static int SAUCERBIG = 8;
	public final static int SAUCERSMALL = 9;
	public final static int BANGALIENSHIP = 10;
	public final static int BANGSHIP = 11;
	
	public final static int BACKGROUNDMUSIC = 101;
	public final static int MENUMUSIC = 102;
	public final static int GAMEOVER = 103;
	//----------------------------------------//
}
