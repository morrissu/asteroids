...
public class AlienBullet extends Participant implements ShipDestroyer, AsteroidDestroyer {
	 ...
	 * 
	 * Creates an bullet and positions it at the provided coordinates with a
	 * random rotation. Its velocity has the given speed but is in a random
	 * direction.
	 */
	public AlienBullet(double x, double y, double rotation, Controller controller) {
		// Create the bullet
	...
	/**
	 * VinC added, When the bullet collides with a ShipDestroyer or an
	 * AsteroidDestroyer , it expires.
	 */
	@Override
